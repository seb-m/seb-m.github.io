/*
Generate a scalar value n that lead to a wrong n.BP computation.

Usage:

$ ./tweetnacl_bug
Found scalar value (loop 26254):
5a22083abc7bdb6371f4e40a6e562b7d3fe3ba87131ab6e9feb341f909f3f581

$ ./tweetnacl_bug 5a22083abc7bdb6371f4e40a6e562b7d3fe3ba87131ab6e9feb341f909f3f581
scalar value:
5a22083abc7bdb6371f4e40a6e562b7d3fe3ba87131ab6e9feb341f909f3f581

scalarmult_base with bug:
48be9f54edc1d033404e0a9942f58b26d6093ad3e3ab26ff4374f3b0a4e00000

scalarmult_base without bug:
35be9f54edc1d033404e0a9942f58b26d6093ad3e3ab26ff4374f3b0a4e0ff7f
*/
#include <stdio.h>
#include <stdlib.h>
#include <sys/types.h>
...
static int check(const u8 n[32], int display) {
  int ret;
  u8 pk1[32];
  u8 pk2[32];
  ...
  if (ret == 0) {
    printf("Values as expected, no bug!\n");
    return ret;
  }
  ...
  printf("scalarmult_base with bug:\n");
  print(pk1, 32);
  printf("\n");

  printf("scalarmult_base without bug:\n");
  print(pk2, 32);
  printf("\n");
...
static void find() {
  ...
  while (42) {
    ...
    if (ret == 1 && check(sk, 0)) {
      printf("Found scalar value (loop %llu):\n", count);
      print(sk, 32);
      printf("\n");
      break;
    }
...
int main(int argc, char *argv[]) {
  ...
  if (argc == 1) {
    ...
    hex_to_bytes(n, (unsigned char *)argv[1]);
    check(n, 1);
  }
